...
import Stats from "@/app/component/Admin/Stats";
...
const [draftMembershipTypeFilter, setDraftMembershipTypeFilter] = useState(
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] p-4 font-sans md:p-8">
      ...
      <Stats token={token} onUnauthorized={handleUnauthorized} />
